        ...
        <main className="min-h-screen">
            ...
            <section id="product" className="border-t border-slate-200 bg-slate-50">
                <div className="mx-auto max-w-6xl px-4 py-12">
                    ...
                    <p className="mt-2 max-w-2xl text-sm text-slate-600">
                        Real screenshots will live here later. For now, think of it as a
                        calm, focused place to read your numbers instead of fighting a
                        spreadsheet.
                    </p>

                    <div className="mt-6 grid gap-4 md:grid-cols-2">
                        <div className="h-40 rounded-xl border border-slate-200 bg-gradient-to-br from-blue-50 via-slate-50 to-emerald-50" />
                        <div className="h-40 rounded-xl border border-slate-200 bg-gradient-to-br from-slate-50 via-slate-100 to-indigo-50" />
                    </div>
                </div>
            </section>
        </main>
